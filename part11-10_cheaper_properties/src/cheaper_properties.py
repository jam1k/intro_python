...
def cheaper_properties(properties: list, reference: RealProperty):
    return [(prop, prop.price_difference(reference)) for prop in properties if prop.square_meters * prop.price_per_sqm < reference.square_meters * reference.price_per_sqm]
